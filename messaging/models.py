# messaging/models.py - مضاد للأخطاء مع البيانات القديمة
...
class Message(models.Model):
    ...
    def get_sender_name(self):
        """الحصول على اسم المرسل - آمن مع البيانات القديمة"""
        try:
            if self.sender_type == 'admin':
                return "الإدارة"
            elif self.sender_type == 'teacher':
                return "معلم"
    ...
    def get_receiver_name(self):
        """الحصول على اسم المستقبل - آمن مع البيانات القديمة"""
        try:
            if self.receiver_type == 'admin':
                return "الإدارة"
            elif self.receiver_type == 'teacher':
                return "معلم"
